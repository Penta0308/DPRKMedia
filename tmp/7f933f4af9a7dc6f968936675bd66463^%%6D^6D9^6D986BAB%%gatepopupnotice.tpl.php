<?php /* Smarty version 2.6.27, created on 2020-05-01 17:32:10
         compiled from gate/gatepopupnotice.tpl */ ?>
<!--
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="gate_popup_notice.aspx.vb" Inherits="KPPress.gate_popup_notice"%>
-->
	...
	<body bgColor="#ffffff" leftMargin="0" topMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="300" border="0">
				...
				<tr>
					<td width="300"><img src="/images/bottom_notice.gif" width="300" height="32" border="0" usemap="#close"></td>
				</tr>
				<map name="close">
