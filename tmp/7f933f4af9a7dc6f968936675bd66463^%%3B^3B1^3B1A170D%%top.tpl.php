						...
						<tr>
							...
							<td width="348">
								<marquee id="mq_Latest" WIDTH="340" HEIGHT="18" scrollAmount="3" direction="left">
									<?php $_from = $this->_tpl_vars['app_ne']['lastestNews']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['val']):
?>
									ㆍ<a href='/viewarticle?ArticleID=<?php echo $this->_tpl_vars['val']['ArticleID']; ?>
' onmouseover="mq_Latest.stop()" onmouseout="mq_Latest.start()"><?php echo $this->_tpl_vars['val']['Title']; ?>
	...
	<tr>
		<td class="time_e" width="148" bgColor="#930400" height="26" align="center">
			<?php echo $this->_tpl_vars['app']['lbl_LastEdit']; ?>
