<?php /* Smarty version 2.6.27, created on 2020-05-01 15:55:22
         compiled from japanese/include/left.tpl */ ?>
<table cellSpacing="0" cellPadding="0" width="132" bgColor="#ffffff" border="0">
	<?php if ($this->_tpl_vars['session']['LoginType'] == 'ID'): ?>
	<tr>
		<td>
			<TABLE cellSpacing="0" cellPadding="0" width="132" bgColor="#ffffff" border="0">
				<TR>
...
?>
			<a href="/listjournal?MediaID=<?php echo $this->_tpl_vars['val']['MediaID']; ?>
"><b><?php echo $this->_tpl_vars['val']['MediaNameJpn']; ?>
 <?php echo $this->_tpl_vars['val']['issue']; ?>
</b></a><br>
