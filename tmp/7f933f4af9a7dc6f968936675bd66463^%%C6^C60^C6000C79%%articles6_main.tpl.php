<?php /* Smarty version 2.6.27, created on 2020-05-01 15:55:29
         compiled from include/articles6_main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'include/articles6_main.tpl', 14, false),)), $this); ?>
<!--
...
<?php $_from = $this->_tpl_vars['app']['article6List']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['val']):
?>
	<tr>
		<td align="left" style="height:20px;">
			<a href="/viewarticle?ArticleID=<?php echo $this->_tpl_vars['val']['ArticleID']; ?>
">[문학신문] <?php echo $this->_tpl_vars['val']['Title']; ?>
</a>
