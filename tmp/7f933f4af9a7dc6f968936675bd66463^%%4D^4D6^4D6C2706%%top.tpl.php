<?php /* Smarty version 2.6.27, created on 2020-05-01 16:15:46
         compiled from gate/include/top.tpl */ ?>
<!--
...
<table cellSpacing="0" cellPadding="0" width="600" bgColor="#ffffff" border="0">
	<tr>
		...
		<td width="84" height="70"><a href="/gate/gateintro" onmouseover="MM_swapImage('m1','','/images/menu_intro02_gate.gif',1)"
		...
		<td width="74" height="70"><a href="/gate/gateguide" onmouseover="MM_swapImage('m2','','/images/menu_guide02_gate.gif',1)"
		...
		<td width="100" height="70"><a href="/gate/gatemedia" onmouseover="MM_swapImage('m3','','/images/menu_media02_gate.gif',1)"
		...
		<td width="78" height="70"><a href="/gate/gateqna" onmouseover="MM_swapImage('m4','','/images/menu_qna02_gate.gif',1)"
		...
		<td width="66" height="70"><a href="/gate/gatecontact" onmouseover="MM_swapImage('m5','','/images/menu_contact02_gate.gif',1)"
		...
		<td width="150" height="70" bgcolor="#093744" align="center">
			<select onchange="javascript:document.location =this.value" name="lang">
				<option value="/gate/gatemain" selected>조선어/朝鮮語</option>
				<option value="/gate/gatemainjpn">日本語/일본어</option>
			</select>
		</td>
	</tr>
</table>