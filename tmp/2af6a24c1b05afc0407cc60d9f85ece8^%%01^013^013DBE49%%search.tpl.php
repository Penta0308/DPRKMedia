<?php /* Smarty version 2.6.27, created on 2020-05-07 10:49:31
         compiled from japanese/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'google_highlight', 'japanese/search.tpl', 112, false),array('modifier', 'date_format', 'japanese/search.tpl', 116, false),)), $this); ?>
<?php echo '
...
"><?php echo $this->_sections['i']['index']; ?>
									...
									<select name="ddlWhere" id="ddlWhere">
										<option <?php if ($this->_tpl_vars['form']['ddlWhere'] == 'news'): ?>selected="selected"<?php endif; ?> value="news">ニュース</option>
										<option <?php if ($this->_tpl_vars['form']['ddlWhere'] == 'journal'): ?>selected="selected"<?php endif; ?> value="journal">ジャーナル</option>
										<option <?php if ($this->_tpl_vars['form']['ddlWhere'] == 'photo'): ?>selected="selected"<?php endif; ?> value="photo">写真</option>
									</select>
									&nbsp;
...
?>
												<tr>
													<td align="left">
														<a href="/japanese/viewarticle?ArticleID=<?php echo $this->_tpl_vars['val']['ArticleID']; ?>
...
?>
												<tr>
													<td align="left">
														<a href="/japanese/viewjournal?JArticleID=<?php echo $this->_tpl_vars['val']['JArticleID']; ?>
">
...
年 <?php echo $this->_tpl_vars['val']['GwonHo']; ?>
号
													</td>
												</tr>
												<?php endforeach; endif; unset($_from); ?>
...
" border="0">
																...
																<tr>
																	<td>
																		<?php echo $this->_tpl_vars['app']['articleList']['list'][$this->_sections['idx']['index']]['TitleJpn']; ?>
