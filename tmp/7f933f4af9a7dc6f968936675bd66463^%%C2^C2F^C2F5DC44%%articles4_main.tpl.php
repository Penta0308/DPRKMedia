<?php /* Smarty version 2.6.27, created on 2020-05-01 15:55:29
         compiled from include/articles4_main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'include/articles4_main.tpl', 28, false),)), $this); ?>
<!--
...
<table cellSpacing="0" cellPadding="0" width="568" bgColor="#ffffff" border="0">
	<tr>
		<td height="26" bgColor="#e2e2e2">&nbsp;&nbsp;&nbsp;<A href="/listsrc?MediaID=<?php echo $this->_tpl_vars['MediaID']; ?>
" onfocus="this.blur()"><b>조선신보 평양지국</b></A></td>
		<td width="328" bgColor="#e2e2e2"></td>
		<td width="70"><A href="/listsrc?MediaID=<?php echo $this->_tpl_vars['MediaID']; ?>
" onfocus="this.blur()"><IMG height="26" src="/images/btn_main_more.gif" width="70" border="0"></A></td>
	</tr>
	<tr>
...
<?php $_from = $this->_tpl_vars['app']['article4List']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
