<?php /* Smarty version 2.6.27, created on 2020-05-01 15:55:29
         compiled from include/articles3_main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'include/articles3_main.tpl', 28, false),)), $this); ?>
<!--
...
" onfocus="this.blur()"><b>민주조선</b></A></td>
...
<?php $_from = $this->_tpl_vars['app']['article3List']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
