{* <!--
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Top.ascx.vb" Inherits="KPPress.Top_jpn" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
--> *}
<a name="t"></a>
<table cellSpacing="0" cellPadding="0" width="962" bgColor="#ffffff" border="0">
							...
							<tr>
								...
								<td width="348">
									<marquee id="mq_Latest" WIDTH="340" HEIGHT="18" scrollAmount="3" direction="left">
										...
										ㆍ<a href='/japanese/viewarticle?ArticleID={$val.ArticleID}' onmouseover="mq_Latest.stop()" onmouseout="mq_Latest.start()">{$val.Title}</a>
										{/foreach}
									</marquee>
								</td>
								<td width="1" bgColor="#575757"></td>
	...
	<tr>
		<td bgColor="#930400" height="26" colSpan="4">&nbsp;
			<span id="TOP1_lbl_LastEdit" class="time_e">{$app.lbl_LastEdit} 更新</span>
		</td>
