						<table cellSpacing="0" cellPadding="0" width="568" bgColor="#ffffff" border="0">
							<tr>
								<td width="170" height="26" bgColor="#e2e2e2">&nbsp;&nbsp;&nbsp;<b>{$app.articleList.mediaName.MediaNameJpn}</b></td>
								<td align="right" width="398" bgColor="#e2e2e2">最近の3ヶ月の記事一覧です。&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								<td>&nbsp;&nbsp;<a href="javascript:history.back();" class="branch_a">← 前へ戻る</a></td>
								<td align="right"><a href="#t" class="branch_a">↑ 上へ</a>&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<td colSpan="2" width="568" height="15"></td>
							</tr>
