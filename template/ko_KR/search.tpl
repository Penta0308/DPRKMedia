							...
							<tr>
								<td align="center" height="40">
									...
									<select name="ddlWhere" id="ddlWhere">
										<option {if $form.ddlWhere eq "news"}selected="selected"{/if} value="news">뉴스</option>
										<option {if $form.ddlWhere eq "journal"}selected="selected"{/if} value="journal">저널</option>
										<option {if $form.ddlWhere eq "photo"}selected="selected"{/if} value="photo">사진</option>
									</select>
									&nbsp;
									...
									<TD>
										...
										<table class="box" cellspacing="0" border="0" id="dgNews" style="width:100%;border-collapse:collapse;">
											<tbody>
												...
												<tr>
													<td align="left">
														<a href="/viewarticle?ArticleID={$val.ArticleID}&txtKeyword={$app.searchKeyword}">
															[{$val.MediaName}]
											...
											<tbody>
												...
												<tr>
													...
													<td align="left" valign="top" style="width:90px;">
														{$val.BalHengYear}년 {$val.GwonHo}호
													</td>
												</tr>
												{/foreach}
													...
													<td>
														<table height="100%" cellspacing="0" cellpadding="0" width="100" align="center" border="0">
															<tbody>
																...
																<tr>
																	<td>
																		{$app.articleList.list[idx].Title}
																	</td>
																</tr>
															</tbody>
														</table>
								...
								<asp:panel id="pnlVideoMore" runat="server" Visible="False">
									<TR>
										<TD vAlign="middle" align="right" height="40">
											<A href='search.aspx?media=video&amp;keyword=<%=HttpUtility.UrlEncodeUnicode(request("keyword"))%>'>
												<IMG src="/images/icon_searchMore.gif" border="0">
											</A>
										</TD>
									</TR>
								</asp:panel>
							...
							{if $app.articleList.allListCnt eq 0 && $form.ddlWhere ne ""}
								<TR>
									<TD vAlign="middle" align="center" height="100">
										<B>{$form.txtKeyword}</B> 에 대한 검색결과가 없습니다.
									</TD>
								</TR>
							{/if}
