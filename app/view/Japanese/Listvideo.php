...
/**
 *  japanese_listvideo view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_View_JapaneseListvideo extends Kpm_ViewClass
{
    ...
    public function preforward()
    {
		...
		$videoAllList     = $commManager->getMediaAllList(202, 0, 0, $offset, LINES_PER_PAGE);
		$this->getPager($videoAllList['allListCnt'], $offset, LINES_PER_PAGE);
		...
		$this->af->setApp('videoAllList',     $videoAllList);
