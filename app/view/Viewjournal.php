...
/**
 *  viewjournal view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_View_Viewjournal extends Kpm_ViewClass
{
    ...
    public function preforward()
    {
		...
		// Center CONTENTS
		$id               = $this->af->get('JArticleID');
		$articleInfo      = $commManager->getJouralInfoByArticleID($id);
