...
/**
 *  viewarticle Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Viewarticle extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  viewarticle action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Viewarticle extends Kpm_ActionClass
{
    /**
     *  preprocess of viewarticle Action.
     *
     *  @access public
