...
/**
 *  japanese_listetc Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_JapaneseListetc extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  japanese_listetc action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_JapaneseListetc extends Kpm_ActionClass
{
    /**
     *  preprocess of japanese_listetc Action.
     *
     *  @access public
