...
/**
 *  japanese_listall Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_JapaneseListall extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  japanese_listall action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_JapaneseListall extends Kpm_ActionClass
{
    /**
     *  preprocess of japanese_listall Action.
     *
     *  @access public
