...
/**
 *  japanese_search Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_JapaneseSearch extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  japanese_search action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_JapaneseSearch extends Kpm_ActionClass
{
    /**
     *  preprocess of japanese_search Action.
     *
     *  @access public
