...
/**
 *  listphoto Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Listphoto extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  listphoto action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Listphoto extends Kpm_ActionClass
{
    /**
     *  preprocess of listphoto Action.
     *
     *  @access public
