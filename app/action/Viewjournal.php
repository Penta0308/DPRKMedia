...
/**
 *  viewjournal Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Viewjournal extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  viewjournal action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Viewjournal extends Kpm_ActionClass
{
    /**
     *  preprocess of viewjournal Action.
     *
     *  @access public
