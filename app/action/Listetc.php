...
/**
 *  listetc Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Listetc extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  listetc action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Listetc extends Kpm_ActionClass
{
    /**
     *  preprocess of listetc Action.
     *
     *  @access public
