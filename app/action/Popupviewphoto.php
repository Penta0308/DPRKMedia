...
/**
 *  popupviewphoto Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Popupviewphoto extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  popupviewphoto action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Popupviewphoto extends Kpm_ActionClass
{
    /**
     *  preprocess of popupviewphoto Action.
     *
     *  @access public
