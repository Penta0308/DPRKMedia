...
/**
 *  printarticle Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Printarticle extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  printarticle action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Printarticle extends Kpm_ActionClass
{
    /**
     *  preprocess of printarticle Action.
     *
     *  @access public
