...
/**
 *  about_media Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutMedia extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_media action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutMedia extends Kpm_ActionClass
{
    /**
     *  preprocess of about_media Action.
     *
     *  @access public
