...
/**
 *  about_introduction Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutIntroduction extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_introduction action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutIntroduction extends Kpm_ActionClass
{
    /**
     *  preprocess of about_introduction Action.
     *
     *  @access public
