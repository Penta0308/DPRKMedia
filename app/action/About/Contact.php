...
/**
 *  about_contact Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutContact extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_contact action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutContact extends Kpm_ActionClass
{
    /**
     *  preprocess of about_contact Action.
     *
     *  @access public
