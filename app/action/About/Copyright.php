...
/**
 *  about_copyright Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutCopyright extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_copyright action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutCopyright extends Kpm_ActionClass
{
    /**
     *  preprocess of about_copyright Action.
     *
     *  @access public
