...
/**
 *  about_qna Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutQna extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_qna action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutQna extends Kpm_ActionClass
{
    /**
     *  preprocess of about_qna Action.
     *
     *  @access public
