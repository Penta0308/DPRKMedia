...
/**
 *  about_terms Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_AboutTerms extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  about_terms action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_AboutTerms extends Kpm_ActionClass
{
    /**
     *  preprocess of about_terms Action.
     *
     *  @access public
