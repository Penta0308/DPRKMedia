...
/**
 *  searchpast Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_Searchpast extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  searchpast action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_Searchpast extends Kpm_ActionClass
{
    /**
     *  preprocess of searchpast Action.
     *
     *  @access public
