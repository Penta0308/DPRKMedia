...
/**
 *  gate_contactwrite Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_GateContactwrite extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  gate_contactwrite action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_GateContactwrite extends Kpm_ActionClass
{
    /**
     *  preprocess of gate_contactwrite Action.
     *
     *  @access public
