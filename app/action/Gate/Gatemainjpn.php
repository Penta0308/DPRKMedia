...
/**
 *  gate_gatemainjpn Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Form_GateGatemainjpn extends Kpm_ActionForm
{
    /**
     *  @access protected
...
/**
 *  gate_gatemainjpn action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Kpm
 */
class Kpm_Action_GateGatemainjpn extends Kpm_ActionClass
{
    /**
     *  preprocess of gate_gatemainjpn Action.
     *
     *  @access public
    ...
    public function prepare()
    {
        ...
        */
		...
		if ($button != "") {
	        if ($this->af->validate() > 0) {
	        	$this->af->setApp('msglang', 'jp');
	            return 'gate_gatemainjpn';
	        }
		}
    ...
    public function perform()
    {
		...
		if (count($res) > 0) {
			...
			$redirectTo = $this->session->get('ReturnURI') == "" ? "/japanese/index" : $this->session->get('ReturnURI');
